...
app.get('/', function(req, res) {
  res.client.channels.cache.get('yyyyyyyyyyyyyyyyyy').send('指定チャンネルにメッセージ送信!!!');('<a href="https://note.com/exteoi/n/n0ea64e258797</a> に解説があります。');
})
...
client.on("ready", async () => {
  await client.user.setActivity('🥔', { type: ActivityType.Custom, state: "やば" });
